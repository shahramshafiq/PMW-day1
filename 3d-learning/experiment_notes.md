...
**Honest conclusion:** Open3D didn't work on my setup without upgrading the system libraries, which I didn't want to do in the middle of the internship. I'll try it on Google Colab later where the environment is controlled.
...
- **GLIBC hell is real** — even simple library installs can fail depending on system config. Colab is more reliable for this.
...
*Honest reflection: Day 1 was more setup and reading than building. That's fine — I now have a mental model that will make Week 3's reconstruction work make sense.*
